...
$b1 = substr(str_shuffle('0987654321'),1,4);
$b2 = substr(str_shuffle('1234567890QWERTYUIOPLKJHGFDSAZXCVBNM'),1,40);
$Barer = "$b1|$b2";
$curl = curl_init();
curl_setopt_array($curl,array(
CURLOPT_POST => 1,
CURLOPT_URL => 'https://sinnersfollower.tk/api/v1/login',
...
CURLOPT_URL => 'https://sinnersfollower.tk/api/v1/getUserinfo',
CURLOPT_RETURNTRANSFER => true,
...
function transCoin($token,$username,$amount){
$curl = curl_init();
curl_setopt_array($curl,[
CURLOPT_URL => 'https://sinnersfollower.tk/api/v1/transCoin',
CURLOPT_POST => true,
CURLOPT_RETURNTRANSFER => true,
CURLOPT_HTTPHEADER => explode("\n",'user-agent: Dart/2.17 (dart:io)
accept: application/json
...
authorization: Bearer '.$token.'
content-type: application/x-www-form-urlencoded'),
CURLOPT_POSTFIELDS => 'username='.$username.'&coin='.$amount.'',
CURLOPT_ENCODING => 'gzip',
]);
$cd = curl_exec($curl);
return $cd;
}
function setOrder($username,$amount,$token,$order_pk,$followers,$img){
$curl = curl_init();
curl_setopt_array($curl,[
CURLOPT_URL => 'https://sinnersfollower.tk/api/v1/setOrder',
CURLOPT_POST => true,
CURLOPT_RETURNTRANSFER => true,
CURLOPT_HTTPHEADER => explode("\n",'user-agent: Dart/2.17 (dart:io)
accept: application/json
...
authorization: Bearer '.$token.'
content-type: application/x-www-form-urlencoded'),
CURLOPT_POSTFIELDS => 'username='.$username.'&order_pk='.$order_pk.'&amount='.$amount.'&start_count='.$followers.'&type=follow&order_img='.$img.'',
CURLOPT_ENCODING => 'gzip',
]);
$cd = curl_exec($curl);
return $cd;
